...
Pod::Spec.new do |spec|
  ...
  spec.name         = "Layout"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of Layout."
  ...
  # Or just: spec.author    = "Artem Belkov"
  # spec.authors            = { "Artem Belkov" => "bestk1ngarthur@aol.com" }
  # spec.social_media_url   = "https://twitter.com/Artem Belkov"
